...
class FloorPicker {
    constructor(hvacApplication) {
        ...
        this.mainDiv = new CreateElement({
            type: 'div', className: 'FloorPicker_Main_Div', elements: [
                ...
                CreateElement({
                    type: 'div', className: 'FloorPicker_Bottom_Bar', elements: [
                        CreateElement({
                            type: 'button', className: 'FloorPicker_Add_Button', text: '+',
                            onClick: CreateFunction(this, this.addFloor)
                        }),
                        CreateElement({
                            type: 'button', className: 'FloorPicker_Edit_Name_Button', text: 'Edit Name',
                            onClick: CreateFunction(this, this.editFloorName)
                        }),
                        CreateElement({
                            type: 'button', className: 'FloorPicker_Remove_Button', text: '-',
        ...
        for (var i = floorList.length - 1; i >= 0; i--) {
            (function (index) {
                ...
                var row = CreateElement({
                    type: 'div', className: 'FloorPicker_Floor_Row', text: floorName,
